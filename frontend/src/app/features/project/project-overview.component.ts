...
import { PricingSummary } from '../../core/project-api.service';
...
export class ProjectOverviewComponent {
  ...
  protected readonly totalCost = computed(() => this.projectCost() ?? sumCosts(this.tasks().map(task => taskCosts(task, this.resources()))).total);
